...
| 2026-07-22 | [`2026-07-22-prompt-queue.md`](./2026-07-22-prompt-queue.md) | proposed | Interactive prompt queue — ordinary prompts are queued while a compatible agent session is busy, `/queue` exposes pending prompts, and card buttons can delete or reorder queued work. |
